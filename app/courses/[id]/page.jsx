                    ...
                    <div className="p-3 sm:p-4 lg:p-5 bg-white flex flex-col gap-3 sm:gap-4">
                      ...
                      <div className="flex flex-wrap gap-2 sm:gap-3 lg:gap-4">
                        ...
                        {hasAccess && (() => {
                          ...
                          if (dayProgressTests.length === 0) return null;
                          
                          // Check if any tests are submitted and show results
                          const submittedTests = dayProgressTests.filter(t => {
                            const submission = getSubmissionStatus(t.id);
                            return !!submission;
                          });
                          ...
                          return (
                            <div className="flex flex-col gap-2">
                              ...
                              >
                                ...
                                <span className="sm:hidden">Test</span>
                                {hasSubmittedTests && (
                                  <span className="ml-1 px-1.5 py-0.5 bg-green-500 rounded-full text-[10px] font-medium">
                                    ✓
                                  </span>
                                )}
                              </button>
                              
                              {/* Show submission results summary directly on chapter */}
                              {hasSubmittedTests && (
                                <div className="bg-green-50 border border-green-200 rounded-lg p-2 sm:p-3 space-y-1.5">
                                  ...
                                  <button
                                    onClick={() => handleProgressTestClick(index)}
                                    className="text-xs text-indigo-600 hover:text-indigo-800 font-medium mt-1 underline"
                                  >
                                    View Details →
                                  </button>
                                </div>
